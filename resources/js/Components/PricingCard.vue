...
<template>
    <div class="relative border rounded-lg pricing-card"
        ...
        <div class="relative h-full p-5 z-30 overflow-hidden rounded-lg">
            ...
            <span class="pointer-events-none absolute z-10 top-0 left-1/2 -translate-x-1/2 w-full h-2/6 bg-[url('/images/landing/pattern/square-pattern.svg')] bg-[size:65px_65px] mix-blend-plus-lighter [mask-image:radial-gradient(45%_65%_at_50%_0%,#ffffff4D_10%,transparent_65%)]" aria-hidden="true" />
        </div>
